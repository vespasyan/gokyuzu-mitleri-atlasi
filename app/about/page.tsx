      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          ...
          <section className="bg-dark-400/50 backdrop-blur-lg rounded-lg p-8 border border-white/10">
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              “   Gökyüzü Mitleri Atlası”, farklı disiplinlerden genç yaratıcıların bir araya gelerek Türk mitolojisini çağdaş sanat ve dijital teknolojilerle buluşturduğu bir proje olarak tasarlanmıştır. Web sitesinin tüm tasarım ve yazılım süreçleri Fazlı TOSUN'un danışmanlığı ile Ali Eren Uğurlu,  Arya Deniz Altıokka, Şeyma Şimşek tarafından geliştirilmiş, projenin dijital altyapısı ve deneyim tasarımı bu çalışma ile şekillenmiştir.
